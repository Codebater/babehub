...
export const CheckIcon = ({ className, ...props }: { className?: string; [key: string]: unknown }) => (
...
export const InstagramIcon = ({ className, ...props }: { className?: string; [key: string]: unknown }) => (
...
export const TwitterIcon = ({ className, ...props }: { className?: string; [key: string]: unknown }) => (
...
export const LinkedInIcon = ({ className, ...props }: { className?: string; [key: string]: unknown }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className} {...props}>
...
export const BabeHubLogo = ({ className }: { className?: string }) => (
  <svg className={className} viewBox="0 0 250 60" xmlns="http://www.w3.org/2000/svg">
    <title>Babe Hub - Premium OnlyFans Management Agency</title>
    <text x="0" y="45" fontFamily="Poppins, sans-serif" fontWeight="900" fontSize="48" fill="currentColor">
      Babe
    </text>
    <rect x="125" y="0" width="120" height="60" rx="10" fill="var(--color-primary)" />
    <text x="137" y="45" fontFamily="Poppins, sans-serif" fontWeight="900" fontSize="48" fill="black">
      hub
    </text>
  </svg>
);

export const WhatsAppIcon = ({ className, ...props }: { className?: string; [key: string]: unknown }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className} {...props}>
