          ...
          <div className="flex flex-col justify-center text-left lg:pr-12">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
              ...
              <h2 className="text-5xl md:text-6xl font-bold text-text-main tracking-tight leading-tight mb-6">
                {t('marketing.title_part1')}
                <span className="text-primary">{t('marketing.title_highlight')}</span>
              </h2>
              <p className="text-lg text-text-secondary mb-8 max-w-lg">{t('marketing.subtitle')}</p>
              ...
              <div className="mt-12 flex items-center space-x-4">
                ...
                <p className="text-sm text-text-secondary font-medium">
                  {t('marketing.joinedBy')}{' '}
                  <span className="text-text-main font-bold">{t('marketing.creatorsPlus')}</span>
                </p>
              </div>
            </motion.div>
          </div>
