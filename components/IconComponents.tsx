...
export const UsersIcon = ({ className }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-6 3m12 0a9 9 0 1 0-12 0m12 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-6-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
    </svg>
);
